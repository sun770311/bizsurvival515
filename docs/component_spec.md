...
### 1. Artifact Loader (`bizsurvival515/app/utils/artifact_loader.py`)
...
* **Assumptions:**
  Artifact files already exist in the `bizsurvival515/app/artifacts/` directory and were generated by the training pipeline using compatible library versions. Missing files raise explicit errors. Streamlit caching is used so repeated page visits do not trigger repeated disk I/O.

---

### 2. Logistic Feature Builder (`bizsurvival515/app/utils/feature_builder.py`)
...
### 3. Cox Feature Builder (`bizsurvival515/app/utils/cox_feature_builder.py`)
...
### 4. Location Utilities (`bizsurvival515/app/utils/location_utils.py`)
...
### 5. Prediction Tools (`bizsurvival515/app/utils/prediction_tools.py`)
...
### 6. Map Page (`bizsurvival515/app/pages/01_map.py`)
...
### 7. Logistic Regression Page (`bizsurvival515/app/pages/02_logistic_regression.py`)
...
### 8. Cox Models Page (`bizsurvival515/app/pages/03_cox_models.py`)
...
### 9. Findings Page (`bizsurvival515/app/pages/04_findings.py`)
