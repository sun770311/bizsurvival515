"""Script to generate an interactive Plotly map of NYC businesses."""
...
def main() -> None:
    """Load business data, clean coordinates, and generate a Plotly map HTML file."""
    # 1. Load your real data
    # Assuming this script is in your 'map' folder, and data is in '../data'
    data_path = os.path.join(
        os.path.dirname(__file__),
        "../../data/business_points.csv"
    )
    ...
    fig.update_traces(marker={"size": 6, "opacity": 0.9})
    fig.update_layout(
